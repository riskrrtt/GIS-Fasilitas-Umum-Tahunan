    ...
    @push('anjay')
        <script>
            $(document).ready(function () {
                ...
                // Center map on Desa Tahunan, Jepara
                let mainMap = L.map('mapid').setView([-6.617, 110.690], 14);

                // Using OpenStreetMap standard (like Google Maps roadmap view)
                ...
                var pasarIcon = new markerIcon({ iconUrl: '{{ URL::asset('icon/marker_pasar.png') }}' }),
                    ...
                    tempatIbadahIcon = new markerIcon({
                        iconUrl: '{{ URL::asset('icon/marker_agama.png') }}'
                    });
