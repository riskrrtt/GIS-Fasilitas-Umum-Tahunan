                                    ...
                                    <div class="form-group">
                                        <div class="form-row">
                                            <div class="col">
                                                ...
                                                <input type="text" class="form-control" name="nama_sekolah"
                                                    id="nama_sekolah" placeholder="Ex: SDN 1" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-row mt-3">
                                            <div class="col">
                                                ...
                                                <input type="text" class="form-control" name="alamat_sekolah"
                                                    id="alamat_sekolah" placeholder="Ex: Jalan astasura" required>
                                            </div>
                                        </div>
                                        <div class="form-row mt-3">
                                            <div class="col">
                                                <label for="lat">Data latitude</label>
                                                <input type="text-area" class="form-control" name="lat" id="lat"
                                        ...
                                        <div class="form-row mt-3">
                                            <div class="col">
                                                ...
                                                <input type="text-area" class="form-control" name="lng" id="lng"
                                                    placeholder="" required readonly>
                                            </div>
                                        </div>
