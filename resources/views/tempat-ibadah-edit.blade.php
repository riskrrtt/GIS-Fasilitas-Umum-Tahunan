                                    ...
                                    <div class="form-group">
                                        <div class="form-row">
                                            <div class="col">
                                                ...
                                                <input value="{{ $tempatIbadah->nama }}" type="text" class="form-control"
                                                    name="nama_tempat_ibadah" id="nama_tempat_ibadah"
                                                    placeholder="Ex: Pura Desa" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-row mt-3">
                                            <div class="col">
                                                ...
                                                <input value="{{ $tempatIbadah->alamat }}" type="text" class="form-control"
                                                    name="alamat_tempat_ibadah" id="alamat_tempat_ibadah"
                                        ...
                                        <div class="form-row mt-3">
                                            <div class="col">
                                                ...
                                                <input value="{{ $tempatIbadah->lat }}" type="text-area"
                                                    class="form-control" name="lat" id="lat" placeholder="" required
                                                    readonly>
                                            </div>
                                        </div>
                                        <div class="form-row mt-3">
                                            <div class="col">
                                                ...
                                                <input value="{{ $tempatIbadah->lng }}" type="text-area"
                                                    class="form-control" name="lng" id="lng" placeholder="" required
                                                    readonly>
                                            </div>
                                        </div>
