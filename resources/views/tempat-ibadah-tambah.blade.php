                                    ...
                                    <div class="form-group">
                                        <div class="form-row">
                                            <div class="col">
                                                ...
                                                <input type="text" class="form-control" name="nama_tempat_ibadah"
                                                    id="nama_tempat_ibadah" placeholder="Ex: Pura Desa" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-row mt-3">
                                            <div class="col">
                                                ...
                                                <input type="text" class="form-control" name="alamat_tempat_ibadah"
                                                    id="alamat_tempat_ibadah" placeholder="Ex: Jalan astasura" required>
                                            </div>
                                        </div>
                                        <div class="form-row mt-3">
                                            <div class="col">
